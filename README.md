...
토스트마스터즈 인터내셔널(Toastmasters International)은 사람들이 **퍼블릭 스피킹, 커뮤니케이션, 리더십 스킬**을 개발할 수 있도록 돕는 비영리 단체입니다. 현재 **140개국 이상에서 활동하는 글로벌 네트워크**로 성장했습니다.

---

### 📅 1924: The Beginning (시작)
...
- **랄프 C. 스메들리(Ralph C. Smedley) 박사**가 미국 **캘리포니아주 샌타아나(Santa Ana)**에서 창립.  
- 스메들리 박사는 성인들이 **퍼블릭 스피킹에 자신감이 부족**하다는 것을 깨달음.  
- 이를 해결하기 위해 **퍼블릭 스피킹 클럽**을 설립.  
- 첫 번째 공식적인 토스트마스터즈 모임은 **YMCA(기독교 청년회)**에서 열림.

---

### 🌍 1930s–1950s: Expansion & Growth (확장과 성장)
...
- 토스트마스터즈는 캘리포니아를 넘어 **미국 전역으로 확장**됨.  
- 1930년, **캐나다에 첫 번째 클럽**이 설립되면서 **Toastmasters International(토스트마스터즈 인터내셔널)**로 개명됨.  
- 북미 외 첫 번째 클럽이 **1950년대 남아프리카공화국**에서 설립됨.

---

### 🚀 1960s–1980s: Global Recognition (세계적인 인지도 상승)
...
- **유럽, 아시아, 호주**에도 클럽이 설립됨.  
- **1938년, 첫 번째 세계 퍼블릭 스피킹 챔피언십(World Champion of Public Speaking)** 개최.  
- 1980년대까지 **전 세계에 수천 개의 클럽**이 존재하게 됨.

---

### 🌏 1990s–2000s: Digital Transformation (디지털 시대의 변화)
...
- **교육 자료 및 온라인 학습 리소스** 도입.  
- 2017년, 현대적 학습 프로그램인 **Pathways(패스웨이)** 출시.  
- 화상 회의 도구를 활용한 **온라인 모임**이 도입됨.

---

### 🎤 Today: A Global Community (현재: 글로벌 커뮤니티)
...
- 현재 토스트마스터즈는 **140개국 이상, 16,000개 이상의 클럽**이 운영 중.  
- 사람들이 퍼블릭 스피킹과 리더십 스킬을 개발할 수 있도록 지속적으로 지원.  
- **온라인, 하이브리드, 오프라인 모임**을 통해 더욱 접근성이 높아짐.

---

## ✨ Summary (한 줄 요약)
> **Toastmasters started in 1924 and grew into a global organization that helps people develop communication & leadership skills & global social networking.**  
> **"Want to be a great speaker?" → Join Toastmasters!** 🎤🔥  

> **토스트마스터즈는 1924년에 시작되어, 전 세계적으로 퍼블릭 스피킹과 리더십, 글로벌 인적 네트워킹을 향상시키는 조직으로 성장했습니다.**  
> **"말을 잘하고 싶다면?" → 토스트마스터즈에 참여하세요!** 🎤🔥  

<br>
<br>
<br>

# 📕 Toastmasters Role Guide (역할 가이드)
...
토스트마스터즈 모임에서는 단순히 연설만 하는 것이 아니라, 다양한 **역할(Role)**을 맡으며 **커뮤니케이션 & 리더십 스킬**을 향상시킬 수 있습니다.

---

### 🎭 **1. Toastmaster of the Day (TMOD) - Meeting Host / 진행자**
...
**모임 전체를 진행하는 사회자 역할**  
- 연설자를 소개하고, 세션 간 전환을 부드럽게 진행.  
- 모임이 원활하게 운영될 수 있도록 관리.  
- **🔥 경험이 있는 멤버들에게 적합한 역할!**

---

### 🎤 **2. Prepared Speaker - Speech Presenter / 준비된 연설자**
...
**사전에 준비된 연설을 발표하는 역할**  
- Toastmasters Pathways 프로그램을 따라 연설 연습.  
- 스토리텔링, 설득력 있는 연설, 유머 연설 등 다양한 주제 포함.  
- **🔥 퍼블릭 스피킹 & 자신감 향상에 도움!**

---

### 🎭 **3. Table Topics Master - Impromptu Speech Facilitator / 즉흥 연설 진행자**
...
**즉흥 연설(Table Topics) 세션을 진행하는 역할**  
- 참가자들에게 **랜덤한 질문이나 주제**를 주고 즉흥적으로 연설하도록 유도.  
  - 예) **"1분 안에 당신의 꿈의 여행지를 설명하세요!"**  
- **🔥 창의력 & 순발력을 기르는 데 유용!**

---

### 🗣 **4. Table Topics Speaker - Impromptu Speaker / 즉흥 연설자**
...
**즉흥 연설 질문에 답하는 역할**  
- 미리 준비 없이 **즉흥적으로 1~2분 동안 연설**해야 함.  
- **🔥 발표 공포 극복에 효과적!**

---

### ✅ **5. Evaluator - Speech Evaluator / 평가자**
...
**연설자의 발표를 듣고 피드백을 제공하는 역할**  
- **잘한 점 & 개선할 점**을 피드백해야 함.  
  - 예) **"목소리 톤이 좋았어요! 하지만 결론을 더 강조하면 좋겠어요."**  
- **🔥 논리적 사고 & 피드백 스킬 향상!**

---

### ⏳ **6. Timer - Timekeeper / 타이머**
- Tracks speaking time for each session.
- Uses **green (OK), yellow (warning), red (time exceeded)** signals.
- **🔥 Improves time management skills!**

**각 연설과 세션의 시간을 측정하는 역할**  
- **초록(OK) → 노랑(경고) → 빨강(시간 초과)** 신호로 시간 알림 제공.  
- **🔥 시간 관리 능력을 기르는 데 도움!**

---

### 🔡 **7. Grammarian - Language & Expression Monitor / 문법 & 표현 모니터링**
...
**연설자의 문법 & 표현을 기록하는 역할**  
- **좋은 표현 & 잘못된 문법**을 기록하여 피드백 제공.  
- 오늘의 단어(Word of the Day)를 정해서 사용하도록 유도.  
  - 예) **"오늘의 단어: Resilience (회복력) → 연설에서 사용해 보세요!"**  
- **🔥 영어 실력 향상에 도움!**

---

### 🔎 **8. Ah-Counter - Filler Word Checker / 불필요한 습관어 체크**
- Monitors **filler words** like “um”, “uh”, “like”, “you know”.
- Helps speakers eliminate verbal crutches.
- **🔥 Enhances fluency & clarity in speech!**

**연설 중 불필요한 습관어 체크**  
- **"음…", "어…", "like", "you know"** 같은 불필요한 단어 사용 기록.  
- **🔥 더 명확한 연설을 연습하는 데 도움!**

---

### 🎭 **9. General Evaluator - Overall Meeting Reviewer / 모임 전체 평가자**
- Provides **feedback on the overall meeting**.
- Evaluates the effectiveness of all roles.
- **🔥 Develops leadership & analytical skills!**

**오늘 모임의 운영과 역할자들의 활동을 평가하는 역할**  
- **모임이 원활하게 진행되었는지? 부족한 점은 없었는지?** 피드백 제공.  
- **🔥 리더십 & 분석 능력을 기르는 데 유용!**
